...
// To implement DDT
WS.comment('To do delete, it is necessary to create a booking first')
...
WS.comment("Your New Booking ID: $idResult")

WS.comment("The New Booking ID will be used to do delete")

//Define the new booking ID to put it as the endpoint

GlobalVariable.dummyId = idResult
responseDelete = WS.sendRequest(findTestObject('EP_Booking/Delete Booking'))
